...
class ByCalendarFragment : BaseFragment<FragmentByCalendarBinding>(FragmentByCalendarBinding::inflate) {
    private val recordEntities: ArrayList<RecordEntity> = arrayListOf<RecordEntity>(
        ...
        RecordEntity(5, 0, "시각으로 감각한 좋아하는 거", null, "2022.06.01", 4.0f),
        RecordEntity(6, 1, "청각으로 감각한 좋아하는 거", null, "2022.06.08", 4.0f),
        RecordEntity(7, 2, "후각으로 감각한 좋아하는 거", null, "2022.06.15", 4.0f),
        RecordEntity(8, 3, "미각으로 감각한 좋아하는 거", null, "2022.06.22", 4.0f),
        RecordEntity(9, 4, "촉각으로 감각한 좋아하는 거", null, "2022.06.29", 4.0f),
        RecordEntity(10, 5, "모르겠어요 감각 좋아하는 거", null, "2022.07.20", 4.0f)
    )
